...
const { serialize, fetchJson, sleep, getBuffer } = require("./lib/myfunc.js");
...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./lib/Upload_Url.js')
...
console.log(chalk.yellow(`${chalk.red('[ Made By Devz ]')}\n\n${chalk.italic.magenta(`Buy Sc/Kebutuhan Panel Yang Lainnya? Pm (private messagae) Devz\nNomor: 6287763771844\nSebut Nama👆,`)}\n\n\n${chalk.red(`ADMIN SEDIA`)}\n${chalk.white(`-PANEL RUN BOT\n-ALL SCRIPT BOT WHATSAPP\n-ADMIN PANEL/PT PANEL\n-SUNTIK SOSMED\n`)}`))
