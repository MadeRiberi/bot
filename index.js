...
const isOwner = [`${setting.ownerNumber}`,"6287763771844@s.whatsapp.net","6287763771844@s.whatsapp.net"].includes(sender) ? true : false
...
reply(`*「 GROUP LINK DETECTOR 」*\n\nTerdeteksi mengirim link group,Maaf sepertinya kamu akan di kick deh`)
...
Saya adalah Bot store M.Games yang bisa membantu anda 

Berikut List produk Kami yah kak🙏,
Jangan Lupa untuk order ya Ayyy, Jangan di liat doangg👍
${strip_ny}
${prefix}freefire
${prefix}mobilelegend
`
...
case 'youtube':
	ramz.sendMessage(from, 
{text: `Jangan Lupa Subs yah kak😉🙏
*Link* : ${setting.linkyt}`},
{quoted: lept})
break
case 'ig':
case 'instagram':
	ramz.sendMessage(from, {text: `Jangan Lupa Follow IG M.Games Ya!\n\nLink \n${setting.linkig}`},
{quoted: lept})
break
case 'gc':
case 'groupadmin':
...
Untuk list lain nya bisa ditanya🥰
