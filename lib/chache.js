...
console.log(chalk.cyanBright(`Module ${module} Sedang di pantau Oleh Devz ⚡`))
...
require('../index')
nocache('../index', module => console.log(chalk.greenBright('[ MAABEST-MD ]  ') + time + chalk.cyanBright(` "${module}" Telah diupdate!`)))
